...
classifier.add(Conv2D(1, (3,1), input_shape = (782, 318, 1), activation = 'relu'))
...
folder_path = './Observed/Leptodactylus_troglodytes'
os.chdir(folder_path)
files = glob.glob('*png')

for img in files:
	test_image = tf.keras.preprocessing.image.load_img(img, target_size = (782, 318),color_mode='grayscale')
